...
public class ClientView {
    ...
    public ClientView(Scanner scanner, ClientController clientController) {
    ...
    public void clientMenu() {
        ...
        while (!back) {
            ...
            switch (choice) {
                case 1: consulterInfosClient(); break;
                case 2: consulterComptesClient(); break;
                case 3: consulterHistorique(); break;
